...
class Auth with ChangeNotifier {
  ...
  static const _url =
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCwN3SsFC9G1YzuEbV45GnpdqXioF475vA';

  Future<void> _authenticate(
      String email, String password, String urlFragment) async {
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlFragment?key=AIzaSyCwN3SsFC9G1YzuEbV45GnpdqXioF475vA';
